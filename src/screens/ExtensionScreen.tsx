...
import { OCCASION_LABELS, verdictForOccasion, type OccasionLabel } from '../data/occasionVerdicts'

type Props = { onOccasionCapsuleCta: () => void }
...
export function ExtensionScreen({ onOccasionCapsuleCta }: Props) {
